...
__m256 fy::simd::intrinsic::log1p(__m256 input) noexcept
{
	...
	const __m256i t_huge = _mm256_set1_epi32(0x5a000000);
	const __m256i t_inf = _mm256_set1_epi32(0x7f800000);
	...
	__m256i m_ax_ge_one = _mm256_cmpgt_epi32(ax, _mm256_set1_epi32(0x3f7fffff));
