...
static __m256 erfc_small_branch(__m256 z, __m256 ax, __m256 neg_mask, 
	__m256 blend_mask)
{
...
static __m256 erfc_mid_branch(__m256 ax, __m256 neg_mask, __m256 blend_mask)
{
...
__m256 fy::simd::intrinsic::erfc(__m256 input) noexcept
{
	...
	{
		result = erfc_mid_branch(ax, is_neg, mask_mid);
	}
